...
const fw = @import("framework-runtime").window;
const math = std.math;
const zm = @import("framework-runtime").renderer.math;

const zbgfx = @import("framework-runtime").renderer.zbgfx;
...
pub fn main() anyerror!u8 {
    ...
    // Create window
    //
    var window = fw.Window.init("debug draw", WIDTH, HEIGHT);
    defer window.deinit();
    //
    ...
    // Set native handles
    //
    bgfx_init.platformData.nwh = window.getNativePtr();
    ...
    while (!window.shouldClose()) {
        ...
        // DebugDraw
        {
            ...
            dde.push();
            {
                ...
                dde.drawTriangle(.{ 1, -2, 0 }, .{ 0, -4, 2 }, .{ 0, -4, -2 });
            }
        }
